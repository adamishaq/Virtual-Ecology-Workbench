...
public class TableSorter extends AbstractTableModel {
    ...
    public TableSorter(TableModel _tableModel) {
        this();
        setTableModel(_tableModel);
    }

    public TableSorter(TableModel _tableModel, JTableHeader _tableHeader) {
        this();
    ...
    public void setTableModel(TableModel _tableModel) {
        if (tableModel != null) {
    ...
    public void setTableHeader(JTableHeader _tableHeader) {
        if (tableHeader != null) {
    ...
    private static class Arrow implements Icon {
        ...
        public Arrow(boolean _descending, int _size, int _priority) {
    ...
    private class SortableHeaderRenderer implements TableCellRenderer {
        ...
        public SortableHeaderRenderer(TableCellRenderer _tableCellRenderer) {
    ...
    private static class Directive {
        ...
        public Directive(int _column, int _direction) {
            column = _column;
